...
// Pippino specific
#include "pippino_interfaces/srv/pippino_video_stream.hpp"
...
public:
  VideoStreamController() : Node("video_stream_controller")
  {
    ...
    // control service
    video_stream_service = this->create_service<pippino_interfaces::srv::PippinoVideoStream>("pippino_video_stream", std::bind(&VideoStreamController::control_service_callback, this, _1, _2));
  }
...
private:
  ...
  void control_service_callback(const std::shared_ptr<pippino_interfaces::srv::PippinoVideoStream::Request> request,
                                std::shared_ptr<pippino_interfaces::srv::PippinoVideoStream::Response> response)
  {
  ...
  // control service
  rclcpp::Service<pippino_interfaces::srv::PippinoVideoStream>::SharedPtr video_stream_service;
};

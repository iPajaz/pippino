...
def generate_launch_description():
    ...
    fubar_file = LaunchConfiguration('fubar_file')
    ...
    declare_fubar_file_cmd = DeclareLaunchArgument(
        'fubar_file',
    ...
    nav_bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pippino_nav_launch_dir, 'bringup_launch.py')),
    ...
    ld.add_action(declare_fubar_file_cmd)

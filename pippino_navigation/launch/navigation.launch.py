...
def generate_launch_description():
    ...
    nav2_params_path = os.path.join(pkg_share, 'config', 'nav2_params_galactic.yaml')
    ...
    default_nav_to_pose_bt_xml_path = os.path.join(pkg_share, 'config', 'bt_navigate_to_pose.xml')
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument(name='default_nav_to_pose_bt_xml', default_value=default_nav_to_pose_bt_xml_path,
